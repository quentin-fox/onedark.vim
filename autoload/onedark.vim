...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#BE5046", "cterm": "204", "cterm16": "1" }),
      \ "dark_red": get(s:overrides, "dark_red", { "gui": "#a83841", "cterm": "196", "cterm16": "9" }),
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#7eb7e6", "cterm": "39", "cterm16": "4" }),
      \ "purple": get(s:overrides, "purple", { "gui": "#AD82BA", "cterm": "170", "cterm16": "5" }),
      \ "cyan": get(s:overrides, "cyan", { "gui": "#67ab9e", "cterm": "38", "cterm16": "6" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#262626", "cterm": "236", "cterm16": "8" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#353535", "cterm": "237", "cterm16": "15" }),
      \ "menu_grey": get(s:overrides, "menu_grey", { "gui": "#353535", "cterm": "237", "cterm16": "8" }),
